...
func TestEncodeShipped_StreamsWrittenDuringRead(t *testing.T) {
	...
	require.NoError(t,
		encodeShipped(ctx, pool, []*pairPlan{plan}, "auto", DefaultFingerprinter{}, rep, 0, 0, 0, 0))
...
func TestEncodeShipped_WarningOnError_FallbackToFull(t *testing.T) {
	...
	err = encodeShipped(ctx, pool, []*pairPlan{plan}, "auto", DefaultFingerprinter{}, progress.NewLine(&buf), 0, 0, 0, 0)
